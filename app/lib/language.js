...
export const translations = {
  en: {
    ...
    taglineSub:
      "Report civic issues in Hyderabad instantly. One photo. Zero forms. Direct to GHMC.",
    ...
    successMsg:
      "Your complaint has been sent to the GHMC ward officer. You will receive an update within 72 hours. If unresolved, it will auto-escalate to the supervisor.",
    ...
    categories: {
      ...
      "Monsoon Damage": "Monsoon Damage",
      "Other Monsoon/Flood-related issues": "Other Monsoon/Flood-related issues",
      Other: "Other",
    },
  },
  ...
  te: {
    ...
    successMsg:
      "మీ ఫిర్యాదు GHMC వార్డు అధికారికి పంపబడింది. 72 గంటల్లో అప్డేట్ అందుతుంది. పరిష్కరించకపోతే పర్యవేక్షకుడికి స్వయంచాలకంగా పంపబడుతుంది.",
    ...
    categories: {
      ...
      Flooding: "వరదలు",
      "Drainage Overflow": "కాలువ పొంగిపొర్లడం",
      "Monsoon Damage": "వర్షాకాల నష్టం",
      "Other Monsoon/Flood-related issues": "ఇతర వర్షాకాల/వరద సమస్యలు",
      Other: "ఇతర",
    },
  },
};
