...
{"primary_category":"Pothole|Garbage|Streetlight|Waterlogging|Encroachment|Other","confidence":85,"severity":"Low|Medium|High","auto_title":"Short 5-8 word title","auto_description":"2-3 sentence description of the issue","secondary_issues":[],"urgent":false,"estimated_repair":"₹5,000–₹15,000","department":"GHMC Roads|GHMC Sanitation|GHMC Lighting|HMWS&SB|GHMC Encroachment|GHMC General"}`,
  ...
  useEffect(() => {
    ...
    function initReportMap() {
      ...
      const defaultLat = location?.lat || 17.385;
  ...
  }, [locationMode, location?.lng, location?.lat, location]);
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      try {
          ...
          .insert([
            {
              ...
              secondary_issues:
                secondaryIssues && secondaryIssues.length > 0
                  ? JSON.stringify(secondaryIssues)
                  : null,
            },
          ])
          .select();
        ...
        console.warn(
          "Advanced column insert blocked. Performing graceful fallback insert:",
          advancedErr,
        );
        ...
        return (
          ...
          >
            ...
            <span style={{ fontSize: 12 }}>
              Ward Area: <strong>{getWard(location.lat, location.lng)}</strong>
            </span>
    ...
    >
      ...
      <div style={{ maxWidth: 480, margin: "0 auto" }}>
        ...
        >
          ...
          >
            {photo ? (
              ...
              <div style={{ padding: "2rem 1.5rem", textAlign: "center" }}>
                ...
                <p style={{ fontSize: 12, color: "#9ca3af", marginBottom: 14 }}>{t.orGallery}</p>
                <span
                  style={{
                    fontSize: 11,
                    background: "#e2e8f0",
          ...
          {/* AI FAILURE CARD */}
          {aiResult?.error && !aiLoading && photo && (
            <div
              style={{
                background: "#fffbeb",
                borderRadius: 20,
            ...
            >
              <div>
                ...
                <p
                  style={{ fontSize: 12, color: "#78350f", marginTop: 4, margin: 0, opacity: 0.85 }}
                >
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: 17, fontWeight: 800, color: "#111827", margin: 0 }}>
